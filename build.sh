...
# Zip for deployment
cd src
zip -r ../build/chrome/obsidian-clipper-${VERSION}.zip .
cd ../
...
mv src.crx build/chrome/obsidian-clipper-${VERSION}.crx
...
mv web-ext-artifacts/obsidian_clipper-${VERSION}.zip ../build/firefox/obsidian-clipper-${VERSION}.zip
